...
$badges = array(
	array(
		...
		'sub'   => __( 'On orders over $50', 'enhanced' ),
	),
	array(
		...
		'title' => __( 'Easy Returns', 'enhanced' ),
		'sub'   => __( '30-day return policy', 'enhanced' ),
	),
	array(
		...
		'title' => __( 'Secure Payment', 'enhanced' ),
		'sub'   => __( '100% secure checkout', 'enhanced' ),
	),
	array(
		...
		'sub'   => __( 'We are here to help', 'enhanced' ),
	),
);
?>
