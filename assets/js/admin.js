...
jQuery( function ( $ ) {
	'use strict';
	var emptyMessage = 'No images yet. Click &ldquo;+ Upload Images&rdquo; to add as many slides as you want.';
	...
	$( document ).on( 'click', '.en-rp-upload-btn', function ( e ) {
		...
		frame.on( 'select', function () {
			...
			$thumbs.find( '.en-rp-thumb' ).each( function () {
				existingIds[ String( $( this ).data( 'id' ) ) ] = true;
			} );
